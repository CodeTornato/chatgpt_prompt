#give a intial prompt to make chat-gpt speak in way you want(like a humourous one or a serious one).
import os
import openai
...
#here you can define the personality and the behivour of the bot,like funny , professional choose as what you like
